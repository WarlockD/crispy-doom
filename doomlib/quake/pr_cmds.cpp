...
void PF_normalize (void)
{
	...
	nnew = value1[0] * value1[0] + value1[1] * value1[1] + value1[2]*value1[2];
	nnew = sqrt(nnew);
	...
	{
		nnew = 1/ nnew;
		newvalue[0] = value1[0] * nnew;
		newvalue[1] = value1[1] * nnew;
		newvalue[2] = value1[2] * nnew;
	}
