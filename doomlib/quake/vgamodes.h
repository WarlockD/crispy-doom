...
EXTERN_CPP int		VGA_InitMode (viddef_t *vid, vmode_t *pcurrentmode);
EXTERN_CPP void	VGA_SwapBuffers (viddef_t *vid, vmode_t *pcurrentmode, vrect_t *rects);
EXTERN_CPP void	VGA_SetPalette (viddef_t *vid, vmode_t *pcurrentmode,
						unsigned char *pal);
