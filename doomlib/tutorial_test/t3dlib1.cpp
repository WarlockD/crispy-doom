...
///////////////////////////////////////////////////////////
// this is why we can't have nice htiings
// _lseek is fubar
...
//OF_READ, OF_READWRITE, OF_WRITE
// open the file if it exists
if ((file_handle = _lopen(filename,OF_READ))==-1)
   return(0);
...
//_lseek(file_handle, -(int)(bitmap->bitmapinfoheader.biSizeImage), SEEK_SET);
