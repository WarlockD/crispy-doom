...
static void NET_Null_FreeAddress(net_addr_t *addr) { (void)addr; }
static boolean NET_Null_InitClient(void) {return false;}
static boolean NET_Null_InitServer(void) {return false;}
static void NET_Null_SendPacket(net_addr_t *addr, net_packet_t *packet) { (void)addr; (void)packet; }
static boolean NET_Null_RecvPacket(net_addr_t **addr, net_packet_t **packet) { (void)addr; (void)packet; return false; }
static void NET_Null_AddrToString(net_addr_t *addr, char *buffer, int buffer_len) { (void)addr; (void)buffer; (void)buffer_len; }
static net_addr_t *NET_Null_ResolveAddress(char *address) { (void)address; return NULL; }
...
static void NET_Null_InitAddrTable(void)
{
#if 0
    addr_table_size = 16;
