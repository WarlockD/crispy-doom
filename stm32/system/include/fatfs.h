...
extern
struct dirent *fatfs_readdir(struct dirstream *);
...
extern
void fatfs_rewinddir(struct dirstream *);

extern
long fatfs_telldir(struct dirstream *);

extern
int fatfs_dirfd(struct dirstream *);

extern
struct dirstream *fatfs_fdopendir(int fd);

extern
void fatfs_seekdir(struct dirstream *, long);
